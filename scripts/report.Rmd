...
```{r histPubDate, fig.cap = "Histogram of publication year for all books on Project Guttenberg.", echo = FALSE, out.width = "50%"}
...
```{r correlogram, fig.cap = "Correlogram of the correlation between key variables", echo = FALSE, out.width = "50%"}
...
```{r yearReadability, fig.cap = "Scatter plot of readability difficulty vs publication year.", echo = FALSE, out.width = "50%"}
...
```{r sentimentYear, fig.cap = "Scatterplot of sentiment vs publication year", echo = FALSE, out.width = "50%"}
...
```{r polarityYear, fig.cap = "Scatterplot of year vs polarity.", echo = FALSE, out.width = "50%"}
